...
export const profile: Profile = {
  ...
  avatar: "./avatar.jpg",
  contact: {
    phone: ["+20 1277696483", "+20 1017155596"],
    email: "abdelrhman.mahmoud.200204@gmail.com",
    website: "https://abdelrhman-mahmoud.netlify.app",
    location: "10th Of Ramadan, Egypt"
  },
  summary: "Results-oriented Full-Stack Developer with over five years of experience building scalable web apps from the ground up. Proficient at using React.js to create high-performance Single Page Applications (SPAs) and the PHP/Laravel ecosystem for stable back-end development. Proven project management and leadership abilities, as evidenced by the creation and growth of Code2Z, a cutting-edge e-learning Progressive Web App (PWA) that expands access to technical education. Strong background in database design, digital marketing, and UI/UX implementation, along with a wealth of experience as a web instructor coaching teams and students to achieve real-world results."
};
...
export const projects: Project[] = [
  {
    title: "Code2Z",
    description: "A cutting-edge e-learning Progressive Web App (PWA) built with React.js and PHP/Laravel (RESTful API), MySQL, and Firebase. Features interactive quizzes, progress tracking, and personalized recommendations to expand access to technical education.",
    tags: ["React.js", "PHP", "Laravel", "MySQL", "Firebase", "PWA"],
    image: "https://picsum.photos/seed/code2z/800/400",
    liveUrl: "#",
    sourceUrl: "#"
  },
  {
    title: "EDUX",
    description: "E-learning Platform & Learning Management System built with WordPress, Elementor Pro, Tutor LMS, and WooCommerce. Integrated Kashier payment gateway for seamless course purchases and student management.",
    tags: ["WordPress", "Elementor Pro", "Tutor LMS", "WooCommerce"],
    image: "https://picsum.photos/seed/edux/800/400",
    liveUrl: "https://edux4courses.com",
    sourceUrl: "#"
  },
  {
    title: "API for Drilling Services",
    description: "Corporate website for drilling services company built with PHP and Tailwind CSS. Includes comprehensive portfolio showcase, services catalog, career opportunities section, and client testimonials.",
    tags: ["PHP", "Tailwind CSS", "Corporate"],
    image: "https://picsum.photos/seed/api-drilling/800/400",
